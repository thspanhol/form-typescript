...
function App() {
  ...
  const trocaModalidade = () => setModalidade(modalidade === 'Mensal' ? 'Anual' : 'Mensal');
  ...
  return (
    <div className='background'>
      <div className='main'>
        ...
        {tela === 'confirmar' && <Confirmar trocaTela={trocaTela} plano={plano} modalidade={modalidade} extras={extras}/>}
