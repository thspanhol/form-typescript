  ...
  return (
    <div className='adicionais'>
        ...
        <div className='extras'>
            <div className={props.extras.includes('Serviço extra 01') ? 'extra-escolhido' : 'opção-adicional'}>
            ...
            <div className={props.extras.includes('Serviço extra 02') ? 'extra-escolhido' : 'opção-adicional'}>
            ...
            <div className={props.extras.includes('Serviço extra 03') ? 'extra-escolhido' : 'opção-adicional'}>
          ...
          <button className='voltar-button' onClick={() => props.trocaTela('planos')}>Voltar</button>
          <button className='próximo-button' onClick={() => props.trocaTela('confirmar')}>Próximo Passo</button>
    </div>
  )
};
